...
// (1) 내적의 결과는 스칼라이다.
// (2) 내적의 결과는 B 의 크기와 A 를 B 에 정사영 시킨 벡터의 크기를 곱한 것이다.
// (3) 서로 수직인 두 벡터의 내적은 0 이다.
// (4) 평행한 두 벡터의 내적은 벡터 크기의 곱과 같다.
// (5) 서로 반대 방향인 두 벡터의 내적은 벡터 크기의 곱 * -1 과 같다.
// (6) 자기 자신과의 내적은 cosθ 가 1 이므로, 벡터 크기의 제곱이 된다.
// (7) 0 < 내적 이면, -90° < θ < 90°
// (8) 내적 < 0 이면, 90° < θ < 270°
